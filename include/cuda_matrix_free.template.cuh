...
namespace PSMF
{
  ...
  public:
    ...
    template <typename CellFilter, typename Cell2Id>
    void
  ...
  {
    if (additional_data.mg_level == dealii::numbers::invalid_unsigned_int)
      {
        Assert(
    ...
    const AdditionalData                     additional_data)
  {
    ...
    // if (fe.n_dofs_per_vertex() == 0) // Discontinuous elements
    //   return;
