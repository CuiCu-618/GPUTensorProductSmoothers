...
fig.savefig(f'/scratch/cucui/GPUTensorProductSmoothers/build_DG/Figures/TimeSolution_3D.png', dpi=fig.dpi)
fig.savefig(f'/scratch/cucui/GPUTensorProductSmoothers/build_DG/Figures/TimeSolution_3D.pdf', dpi=fig.dpi)